                ...
                Scaffold(
                  appBar: PreferredSize(
                    preferredSize: Size(MediaQuery
                        .of(context)
                        .size
                        .width, !state.isHome ? 40.0: 0.0),
                    child: !state.isHome ? AppBar(
                      elevation: 8.0,
                      toolbarHeight: 40.0,
                      ...
                      leading: MyBackButton(
                        onTap: () =>
                            context
                                .bloc<FilesTabViewBloc>()
                                .add(FilesTabViewEvent.loadDirectory(
                  ...
                  body: Padding(
                    ...
                    child: GridView.builder(
                      ...
                      index < state.folders.length
                        ...
                        child: InkWell(
                          onTap: () =>
                              context.bloc<FilesTabViewBloc>().add(
                            ...
                            children: [
                              ...
                              Text(
                                state.folders[index].path.substring(
                                    state.folders[index].parent.path.length +
                                        1),
