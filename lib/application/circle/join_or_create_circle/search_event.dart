...
abstract class SearchEvent with _$SearchEvent {
  ...
  const factory SearchEvent.showAllDiscoveredDevices() = ShowAllDiscoveredDevices;
  const factory SearchEvent.dismissAllDiscoveredDevices() = DismissAllDiscoveredDevices;
  ...
  const factory SearchEvent.requestConnection({@required User discoveredUser}) =
      RequestConnection;
  const factory SearchEvent.endConnectionRequest() = EndConnectionRequest;
}
